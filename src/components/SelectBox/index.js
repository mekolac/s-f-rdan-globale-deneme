...
const sizes = {
  sm: "lg:pb-[16px] xl:pb-[18px] 2xl:pb-[20px] pb-[23px] 3xl:pb-[24px] lg:pt-[19px] xl:pt-[22px] 2xl:pt-[25px] pt-[28px] 3xl:pt-[30px] lg:px-[16px] xl:px-[18px] 2xl:px-[20px] px-[23px] 3xl:px-[24px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              backgroundColor: state.isSelected && "#f04037",
              "&:hover": { backgroundColor: "#f04037", color: "#ffffff" },
            }),
