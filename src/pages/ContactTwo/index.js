...
import { Column, Line, Row } from "components";
  ...
  return (
    <>
      <Column className="bg-white_A700 justify-end mx-[auto] lg:pt-[11px] xl:pt-[13px] 2xl:pt-[15px] 3xl:pt-[18px] w-[100%]">
        ...
        <Column className="items-center lg:mt-[290px] xl:mt-[332px] 2xl:mt-[373px] 3xl:mt-[448px] w-[100%]">
          <div className="bg-gray_52 lg:h-[171px] xl:h-[196px] 2xl:h-[220px] 3xl:h-[264px] rounded-radius10 w-[57%]"></div>
          <Column className="items-center lg:mt-[138px] xl:mt-[158px] 2xl:mt-[178px] 3xl:mt-[213px] w-[34%]">
            <div className="bg-white_A700 lg:h-[52px] xl:h-[59px] 2xl:h-[66px] 3xl:h-[79px] outline outline-[0.5px] outline-indigo_50 rounded-radius10 w-[100%]"></div>
            <div className="bg-white_A700 lg:h-[52px] xl:h-[59px] 2xl:h-[66px] 3xl:h-[79px] lg:mt-[49px] xl:mt-[56px] 2xl:mt-[63px] 3xl:mt-[75px] outline outline-[0.5px] outline-indigo_50 rounded-radius10 w-[100%]"></div>
            <div className="bg-white_A700 lg:h-[52px] xl:h-[59px] 2xl:h-[66px] 3xl:h-[79px] lg:mt-[49px] xl:mt-[56px] 2xl:mt-[63px] 3xl:mt-[75px] outline outline-[0.5px] outline-indigo_50 rounded-radius10 w-[100%]"></div>
            <div className="bg-white_A700 lg:h-[105px] xl:h-[121px] 2xl:h-[136px] 3xl:h-[163px] lg:mt-[49px] xl:mt-[56px] 2xl:mt-[63px] 3xl:mt-[75px] outline outline-[0.5px] outline-indigo_50 rounded-radius10 w-[100%]"></div>
            <div className="bg-red_500 lg:h-[42px] xl:h-[49px] 2xl:h-[55px] 3xl:h-[65px] lg:mt-[21px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[33px] outline outline-[0.5px] outline-red_900 rounded-radius10 w-[100%]"></div>
          </Column>
          <footer className="bg-gray_900 xl:mt-[112px] 2xl:mt-[126px] 3xl:mt-[152px] lg:mt-[98px] w-[100%]">
