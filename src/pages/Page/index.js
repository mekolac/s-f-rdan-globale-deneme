    ...
    <>
      <Column className="bg-white_A700 justify-end mx-[auto] lg:pt-[11px] xl:pt-[13px] 2xl:pt-[15px] 3xl:pt-[18px] w-[100%]">
        ...
        <Column className="items-center xl:mt-[113px] 2xl:mt-[127px] 3xl:mt-[153px] lg:mt-[99px] w-[100%]">
          <Stack className="bg-red_500_19 2xl:h-[107px] 3xl:h-[128px] lg:h-[83px] xl:h-[95px] lg:px-[23px] xl:px-[27px] 2xl:px-[30px] 3xl:px-[36px] rounded-radius50 2xl:w-[106px] 3xl:w-[127px] lg:w-[82px] xl:w-[94px]">
            <Img
              src="images/img_reply.svg"
              className="absolute lg:h-[33px] xl:h-[37px] 2xl:h-[42px] 3xl:h-[50px] inset-[0] justify-center m-[auto] w-[41%]"
              alt="reply"
            />
          </Stack>
