  ...
  return (
    <>
      <Column className="bg-white_A700 justify-end mx-[auto] lg:pt-[11px] xl:pt-[13px] 2xl:pt-[15px] 3xl:pt-[18px] w-[100%]">
        ...
        <Column className="items-center lg:mt-[217px] xl:mt-[248px] 2xl:mt-[279px] 3xl:mt-[334px] w-[100%]">
          <Img
            src="images/img_group3.svg"
            className="2xl:h-[10px] 3xl:h-[11px] lg:h-[7px] xl:h-[9px] w-[10%]"
            alt="GroupThree"
          />
          <Row className="items-center justify-center xl:mt-[100px] 2xl:mt-[112px] 3xl:mt-[135px] lg:mt-[87px] w-[69%]">
            <Img
              src="images/img_content_gray_600.svg"
              className="lg:h-[1091px] xl:h-[1248px] 2xl:h-[1404px] 3xl:h-[1684px] w-[66%]"
              alt="Content"
            />
            <Img
              src="images/img_sidebar.svg"
              className="lg:h-[1058px] xl:h-[1210px] 2xl:h-[1361px] 3xl:h-[1633px] lg:ml-[21px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[32px] w-[32%]"
              alt="Sidebar"
            />
          </Row>
          <Column className="items-center xl:mt-[101px] 2xl:mt-[114px] 3xl:mt-[137px] lg:mt-[88px] w-[100%]">
            <Img
              ...
              className="lg:h-[1067px] xl:h-[1220px] 2xl:h-[1372px] 3xl:h-[1646px] w-[100%]"
              alt="Comment"
            />
