          ...
          <Column className="w-[69%]">
            <Row className="justify-between w-[100%]">
              <Img
                ...
                className="lg:h-[1195px] xl:h-[1367px] 2xl:h-[1538px] 3xl:h-[1845px] mt-[1px] w-[66%]"
                alt="List"
              />
              <Img
                src="images/img_sidebar_1511X350.svg"
            ...
            <Img
              ...
              className="lg:h-[27px] xl:h-[31px] 2xl:h-[35px] 3xl:h-[42px] lg:mt-[49px] xl:mt-[56px] 2xl:mt-[63px] 3xl:mt-[76px] w-[29%]"
              alt="Pagination"
            />
          </Column>
