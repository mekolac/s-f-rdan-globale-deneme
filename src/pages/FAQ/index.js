  ...
  return (
    <>
      <Column className="bg-white_A700 justify-end mx-[auto] lg:pt-[11px] xl:pt-[13px] 2xl:pt-[15px] 3xl:pt-[18px] w-[100%]">
        ...
        <div className="bg-gray_50 border border-indigo_50 border-solid lg:h-[203px] xl:h-[232px] 2xl:h-[261px] 3xl:h-[313px] lg:ml-[184px] xl:ml-[210px] 2xl:ml-[236px] 3xl:ml-[284px] 3xl:mr-[1136px] lg:mr-[736px] xl:mr-[842px] 2xl:mr-[947px] lg:mt-[247px] xl:mt-[282px] 2xl:mt-[317px] 3xl:mt-[381px] rounded-radius10 w-[18%]"></div>
        <Column className="items-center lg:mt-[381px] xl:mt-[436px] 2xl:mt-[490px] 3xl:mt-[588px] w-[100%]">
