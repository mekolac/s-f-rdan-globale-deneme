  ...
  return (
    <>
      <Column className="bg-white_A700 justify-end mx-[auto] lg:pt-[11px] xl:pt-[13px] 2xl:pt-[15px] 3xl:pt-[18px] w-[100%]">
        ...
        <Column className="items-center lg:mt-[343px] xl:mt-[392px] 2xl:mt-[441px] 3xl:mt-[529px] w-[100%]">
          <Img
            src="images/img_table.svg"
            className="lg:h-[446px] xl:h-[510px] 2xl:h-[574px] 3xl:h-[689px] w-[69%]"
            alt="Table"
          />
          <Column className="items-center xl:mt-[101px] 2xl:mt-[114px] 3xl:mt-[137px] lg:mt-[88px] w-[100%]">
            <div className="bg-gray_50 2xl:h-[1036px] 3xl:h-[1243px] lg:h-[805px] xl:h-[921px] w-[100%]"></div>
